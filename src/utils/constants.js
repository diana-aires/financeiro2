...
export const CATS_D = ["Aluguel", "Energia", "Internet", "Telefone", "Assinaturas", "Alimentação", "Transporte", "Viagem", "Lazer", "Compras", "Investimento", "Saúde", "Beleza", "Insumos", "Doação", "Empréstimo", "Financiamento", "Outro"];
export const TIPO_R = { "Salário CLT": "fixa", Consultoria: "variavel", Honorários: "variavel", Comissão: "variavel", Projeto: "variavel", "Curso/Treinamento": "variavel", "Prestação de Serviços": "variavel", Outro: "variavel" };
export const TIPO_D = { Aluguel: "fixa", Energia: "fixa", Internet: "fixa", Telefone: "fixa", Assinaturas: "fixa", Alimentação: "variavel", Transporte: "variavel", Viagem: "variavel", Lazer: "variavel", Compras: "variavel", Investimento: "variavel", Saúde: "variavel", Beleza: "variavel", Insumos: "variavel", Doação: "variavel", Empréstimo: "fixa", Financiamento: "fixa", Outro: "variavel" };

...
function Landing({ onEnter }) {
  const gradientStyle = {
    background: "linear-gradient(135deg, " + C.navy + ", #1e40af, #1d4ed8)",
  ...
  return React.createElement("div", { style: { color: "#1E293B" } },
    React.createElement("nav", { style: { background: "rgba(255,255,255,.92)", borderBottom: "1px solid " + C.border, padding: "0 1.5rem" } },
      React.createElement("div", { style: { maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", height: 60 } },
        React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, flex: 1 } },
          React.createElement("div", { style: { width: 32, height: 32, borderRadius: 8, background: C.navy, display: "flex", alignItems: "center", justifyContent: "center" } },
            React.createElement("i", { className: "ti ti-chart-pie-2", style: { color: "#fff", fontSize: 17 } })
          ),
          React.createElement("span", { style: { fontWeight: 600, fontSize: 16, color: C.navy } }, "FinancePro")
        ),
        React.createElement("button", { onClick: onEnter, className: "btn-green", style: { background: C.green, color: "#fff", border: "none", borderRadius: 8, padding: "8px 20px", fontSize: 13, fontWeight: 500, cursor: "pointer" } }, "Entrar")
      )
    ),
    React.createElement("section", { style: gradientStyle },
      React.createElement("h1", { style: { fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 700, color: "#fff", lineHeight: 1.15, margin: "0 auto 1.25rem", maxWidth: 600 } },
        "Controle total da sua vida financeira"
      ),
      React.createElement("p", { style: { fontSize: 17, color: "rgba(255,255,255,.75)", lineHeight: 1.7, margin: "0 auto 2rem", maxWidth: 500 } },
        "Parcelas, financiamento, m\xFAltiplas rendas e IA consultora. Grátis."
      ),
      React.createElement("button", { onClick: onEnter, className: "btn-green", style: buttonStyle }, "Criar minha conta")
    )
  );
}
